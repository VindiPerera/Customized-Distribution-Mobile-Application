            ...
            <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data" class="bg-surface border border-line shadow-sm rounded-lg p-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="sku" name="sku" value="{{ old('sku', $product->sku) }}" class="mt-1 block w-full" autofocus placeholder="Auto-generated if left blank" />
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="supplier_id" name="supplier_id" class="mt-1 block w-full border-line rounded-md shadow-sm text-sm bg-surface text-ink focus:border-accent focus:ring-accent">
